...
const ZSH_BUILD_DIR: &str = "zsh_build";
...
const ZSH_VERSION_ENV: &str = "ZSH_VERSION";
...
impl Locations {
    fn from(wrapper: &Path, src_dir: &Path, build_dir: &Path) -> Self {
        Self {
...
fn zsh_prebuild(root: &Path, submod: &PathBuf, build_dir: &PathBuf) -> Locations {
...
mod commands {
    ...
    pub(super) fn configure(root: &Path, submod: &Path, zsh_build: &PathBuf) {
...
fn get_target_dir(out_dir: &Path) -> Option<PathBuf> {
